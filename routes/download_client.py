...
def download_client(client_name):
    # Client config file is always saved in /etc/openvpn/client folder
    ...
    if os.path.exists(client_path):
        ...
        return jsonify({'status': 'error', 'message': f'Client configuration file {client_name}.ovpn not found in /etc/openvpn/client folder'})
